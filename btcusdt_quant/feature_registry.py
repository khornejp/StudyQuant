...
FEATURE_DEFINITIONS: list[FeatureDefinition] = [
    ...
    _feature("spread", "F11", MICROSTRUCTURE, "(best_ask_t - best_bid_t) / mid_price_t", 1, 1, "depth_snapshot", scaffold_status="mock_implemented"),
    _feature("spread_bps", "F11", MICROSTRUCTURE, "10000 * (best_ask_t - best_bid_t) / mid_price_t", 1, 1, "depth_snapshot", ("spread",), scaffold_status="mock_implemented"),
    _feature("bid_ask_imbalance", "F11", MICROSTRUCTURE, "(best_bid_qty_t - best_ask_qty_t) / max(best_bid_qty_t + best_ask_qty_t, 1e-12)", 1, 1, "depth_snapshot", scaffold_status="mock_implemented"),
    _feature("best_bid_qty_ratio", "F11", MICROSTRUCTURE, "best_bid_qty_t / max(best_bid_qty_t + best_ask_qty_t, 1e-12)", 1, 1, "depth_snapshot", scaffold_status="mock_implemented"),
    _feature("best_ask_qty_ratio", "F11", MICROSTRUCTURE, "best_ask_qty_t / max(best_bid_qty_t + best_ask_qty_t, 1e-12)", 1, 1, "depth_snapshot", scaffold_status="mock_implemented"),
    _feature("microprice_deviation", "F11", MICROSTRUCTURE, "(microprice_t - mid_price_t) / mid_price_t", 1, 1, "depth_snapshot", scaffold_status="mock_implemented"),
    _feature("order_book_pressure", "F11", MICROSTRUCTURE, "rolling order book imbalance pressure observed through t", 1, 1, "depth_snapshot", scaffold_status="mock_implemented"),
    _feature("adl_indicator", "F12", EXCHANGE_SAFETY, "exchange ADL quantile indicator observed at t", 1, 1, "adl_quantile", warmup_rule="state", leakage_risk="low_state_snapshot", scaffold_status="mock_implemented"),
    _feature("funding_rate", "F12", EXCHANGE_SAFETY, "current funding rate observed at t", 1, 1, "funding_rate", warmup_rule="state", leakage_risk="low_state_snapshot", scaffold_status="mock_implemented"),
    _feature("next_funding_rate", "F12", EXCHANGE_SAFETY, "announced next funding rate snapshot observed at t", 1, 1, "funding_rate", warmup_rule="state", leakage_risk="low_state_snapshot", scaffold_status="mock_implemented"),
    _feature("minutes_to_next_funding", "F12", EXCHANGE_SAFETY, "minutes until scheduled funding timestamp at t", 1, 1, "funding_rate", warmup_rule="state", leakage_risk="low_state_snapshot", scaffold_status="mock_implemented"),
    _feature("funding_blackout_active", "F12", EXCHANGE_SAFETY, "1 if t is inside configured funding blackout window else 0", 1, 1, "funding_rate", warmup_rule="state", leakage_risk="low_state_snapshot", scaffold_status="mock_implemented"),
    _feature("mark_price_basis", "F12", EXCHANGE_SAFETY, "(mark_price_t - close_t) / close_t", 1, 1, "mark_price_1m", warmup_rule="state", leakage_risk="low_state_snapshot", scaffold_status="mock_implemented"),
    _feature("premium_index", "F12", EXCHANGE_SAFETY, "exchange premium index observed at t", 1, 1, "premium_index_1m", warmup_rule="state", leakage_risk="low_state_snapshot", scaffold_status="mock_implemented"),
    _feature("leverage_bracket_utilization", "F12", EXCHANGE_SAFETY, "position notional_t / max(current leverage bracket cap_t, 1e-12)", 1, 1, "leverage_bracket", warmup_rule="state", leakage_risk="low_state_snapshot", scaffold_status="mock_implemented"),
]
